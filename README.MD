...
It is designed to make seasonal gear easier to manage inside BetterBags without forcing a one-size-fits-all setup. You can enable only the categories you want, rename them, recolor them, adjust their priority, and pin them into BetterBags’ pinned section.
